...
- all your tickets as Plain **threads**. We will import all messages in the tickets, including internal ones, which are imported as Plain **notes**. Tickets in status _closed_ or _solved_ will be imported as _DONE_ threads. All others will be imported as _TODO_ threads.
