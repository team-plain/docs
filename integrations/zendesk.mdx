...
To connect your Zendesk account, head to **Settings** → **Zendesk integration** and follow the instructions. You will need your _Zendesk subdomain_, e.g. `plain` in `https://plain.zendesk.com/`
