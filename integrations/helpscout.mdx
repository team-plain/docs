...
<Note>
  ...
  is synced into Plain, further changes to that end user in Help Scout (e.g. changing their name)
  will not be synced into Plain. - if a customer or label is modified on Plain after syncing them
  from Help Scout, further syncs from Help Scout will not override your changes on Plain. - the same
