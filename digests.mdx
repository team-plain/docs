...
<Frame>![Plain Digests](/public/images/digests-daily-update.png)</Frame>

Digests are a way to get a summary of activity in your Plain workspace. They are currently only available via our [Slack integration](./slack).

Digests are configued in settings, and you can specify a time (in UTC) when you would like to receive them. They are **only sent on weekdays**.
