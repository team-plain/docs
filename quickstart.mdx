...
<AccordionGroup>
  <Accordion title="Create a workspace" icon="seedling">
    ...
    If you've already done your demo call – you can create your workspace at https://app.plain.com and click **Create a workspace**.&#x20;
  </Accordion>
  ...
  <Accordion title="Invite your team members" icon="user-plus">
    ...
    **Members** in your workspace. You can add your entire team to Plain for free – we'll only charge you for users that actively send messages to customers.
