...
3. **Multiple messages in the main channel, separated by a thread -** Once a Slack thread is created, the next message in the main channel will create a *new* thread in Plain.
