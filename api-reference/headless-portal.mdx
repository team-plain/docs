...
<Warning>
Headless Portal support is only available in our [Scale pricing tier](https://plain.com/pricing). If you are interested in using this feature please reach out to use on sales@plain.com.
...
<Note>It's very helpful to first read our [data model documentation](/docs/data-model) to get your bearings.</Note>
