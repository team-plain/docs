...
---
<Warning>
Headless Portal support is only available in our custom pricing tier. If you are interested in using this feature please reach out to use on sales@plain.com. 
...
In terms of the interaction with Plain however, it's as simple as calling the [`replyToThread` mutation](http://localhost:3000/api-reference/graphql/messaging/reply-to-thread).
...
If based on this high-level overview you are interested in building a headless support portal, please reach out to us on sales@plain.com. 
