...
<Steps>
  <Step title="Install the SDK">```shell npm install @team-plain/typescript-sdk ```</Step>
  <Step title="Set up the code">Make sure to replace the api key and email in the code</Step>
