...
CSAT surveys work across all channels — Slack, Discord, Email, Microsoft Teams, Headless Portal, and API.

Wherever the conversation happens, you can follow up with a feedback request.
...
All responses are stored and visible:
	...
	- In CSAT reports, so you can view response trends over time.
...
- **Be respectful**. Use frequency delays to avoid over-surveying your customers.