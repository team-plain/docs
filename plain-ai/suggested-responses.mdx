...
Suggested responses can be hidden by default on a user level basis, by going to **Settings** → **Personal Settings** and toggling the **Show suggested responses** setting.

When the **Show suggested responses** setting is disabled, suggested responses will no longer appear in the composer, but can be accessed via a button in the composer.
