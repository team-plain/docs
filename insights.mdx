...
| Coming soon: First response time SLA compliance (%) | The percentage of threads that met or breached a first response time SLA.                                           |
...
| Coming soon: Next response time SLA compliance (%) | The percentage of threads that met or breached a next response time SLA.                                               |
