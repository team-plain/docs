...
**Insights** give you an overview of your support workload to allowing you to analyze trends, identify improvement areas and answer questions like:
...
| Threads re-opened per day
| A count of threads that transition back to Todo from either Snoozed or Done. |
...
| Coming soon: First response time SLA compliance (%)
| The percentage of threads that met or breached a first response time SLA. |

**Coming soon: Next response time**

| Metric                                            | Definition                                                                                                             |
| ------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------- |
| Next response time - Median                       | The median time it takes for your team to send additional replies.                                                     |
| Coming soon: Next response time - 90th percentile | The 90th percentile time it takes for your team to send additional replies for support requests that start off slower. |

| Coming soon: Next response time SLA compliance (%)
| The percentage of threads that met or breached a next response time SLA. |
