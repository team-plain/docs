...
Slack messages from the authorized channels will begin appearing as threads in Plain. Press `R` and begin typing in Plain. Your responses will appear in Slack as if you are responding directly in the app. 
