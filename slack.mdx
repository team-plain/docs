...
<Steps>
  ...
  <Step title="Add the Plain app to the channels you want to track">
    Once you’ve set up the integration in Plain, go to the Slack channels you want to track and invite the Plain app. You can do this by typing **`/invite`**, selecting `Add apps to this channel` and then choosing Plain. You can alternatively auto-join or bulk-join channels with specific prefixes in your Slack settings (inside your workspace settings). 

    <Note>
      If you'd like to add Plain to many Slack channels in bulk, reach out via chat or on <a href="mailto:help@plain.com">
      help@plain.com</a>
